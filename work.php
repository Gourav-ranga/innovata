...
$query = "INSERT INTO post_work(roll_no,title,description,work_date) VALUES('$roll_no','$title','$description','$date')"; 
...
<div id="below-header-outer">	<!-- Start Below header Outer -->
 ...
 <div id="work-right-outer">
  <input type="text" placeholder="Title" required="required" name="title" id="work-title-box" style="margin-top: 15px;">
  <textarea name="description" placeholder="Description" required="required" id="work-description-box" style="margin-top: 19px;"></textarea><br>
