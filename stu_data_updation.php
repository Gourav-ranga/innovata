 ...
 if(!isset($_SESSION['id']))
{
 ...
 $query = "UPDATE new_register_verification SET name='$stu_name',dept_name='$dept_name',batch='$batch',mob_no='$mobile',study_year='$yofs' WHERE roll_no='$roll'";
...
<head>
  ...
  <link href="css/style.css" rel="stylesheet" type="text/css">
	...
	<title>Admin student update data</title>
</head>
<body>

 <a href="admin_services.php"><div id="admin-data-insertion">Student Data Updation</div></a>
  ...
  <div id="center-maindiv">		<!-- Center maindiv start -->
    ...
    <form method="POST">
	 <div class="right-text">   <!-- Registration Right Panel Details Start -->
	  ...
	  <input type="submit"  name="submit" value="Update" id="admin-insert-form-submit" >
